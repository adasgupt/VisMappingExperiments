...
// * @version 0.1
// */
//public class DataSetTODO implements Iterable<float[]>{
//
//	/** Contains the float[] values. */
//	//protected ArrayList<float[]> values = new ArrayList<float[]>();
//
//	/** Contains the String[] values. */
//	protected ArrayList<String[]> stringValues = new ArrayList<String[]>();
//
//
//	/**Contains the attribute type.*/
//	protected boolean isNumericalAttribute[] =null;
//
//	/** Contains the record label Strings. */
//	protected ArrayList<String> recordLabels = new ArrayList<String>();
//
...
//	//	}
//	//	
//	public void addStringRecord(String valuesFromData[]) {
//
//		if (numDimensions == 0) {
//			initNumDimensions(valuesFromData.length);
//
//		} 
//		else if (valuesFromData.length != numDimensions) {
//			throw new IllegalArgumentException(
//					"Recordsets must have same number of dimensions ("
//							+ numDimensions + ")");
//		}
//		
//		setAttributeType(valuesFromData);
//		
//		for(int dimension =0; dimension<isNumericalAttribute.length; dimension++)
//		{
//			
//			if(isNumericalAttribute[dimension]==true)
//			{
//				
//				Float val = Float.parseFloat(valuesFromData[dimension]);
//				
//				
//			}
//			
...
//		}
//
//		this.stringValues.add(valuesFromData);
//
//	
//
//
...
//	 *http://stackoverflow.com/questions/2043471/in-java-how-to-get-attribute-given-the-string-with-its-name
//	 * @param valuesFromData
//	 */
//	private void setAttributeType(String[] valuesFromData) {
//
//		 isNumericalAttribute = new boolean[numDimensions];
//
//		for (int i=0; i<valuesFromData.length; i++) {
//			char c = valuesFromData[i].charAt(i);
//			if (Character.isLetter(c)) 
//                 isNumericalAttribute[i] =false;
